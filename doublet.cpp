...
static	char	defaultdic[]="/usr/share/dic/ejdic-hand-utf8-words.txt";
static	FILE	*so;
static	FILE	*fp;
static	int		len;

void get_path(){
  for(long i = N + 1; i != -1; i = pre[i]) path.push_back(word[i]);
